...
public class Main {
  public static void main(String[] args) {
    ...
    List<User> users = Arrays.asList(
        new User(1, "Alice", Arrays.asList(1, 2, 3, 12), 25, "F", "Seoul"),
        new User(2, "Bob", Arrays.asList(2, 3, 4, 34), 30, "M", "Busan"),
        new User(3, "Charlie", Arrays.asList(4, 5, 6, 12), 28, "M", "Seoul"),
        new User(4, "Daisy", Arrays.asList(1, 5, 6, 8), 22, "F", "Seoul"),
        new User(5, "Eve", Arrays.asList(3, 4, 20, 21), 35, "F", "Busan")
    );
